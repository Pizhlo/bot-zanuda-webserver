...
func (m *MockuserRepo) CheckUser(ctx context.Context, tgID int64) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockuserRepoMockRecorder) CheckUser(ctx, tgID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckUser", reflect.TypeOf((*MockuserRepo)(nil).CheckUser), ctx, tgID)
}
...
// CheckUser mocks base method.
func (m *MockuserCache) CheckUser(ctx context.Context, tgID int64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckUser", ctx, tgID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
...
// CheckUser indicates an expected call of CheckUser.
func (mr *MockuserCacheMockRecorder) CheckUser(ctx, tgID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckUser", reflect.TypeOf((*MockuserCache)(nil).CheckUser), ctx, tgID)
}
