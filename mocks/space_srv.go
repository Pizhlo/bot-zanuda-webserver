...
// CreateNote mocks base method.
func (m *MocknoteEditor) CreateNote(ctx context.Context, req rabbit.CreateNoteRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateNote", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteAllNotes mocks base method.
func (m *MocknoteEditor) DeleteAllNotes(ctx context.Context, req rabbit.DeleteAllNotesRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAllNotes", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteNote mocks base method.
func (m *MocknoteEditor) DeleteNote(ctx context.Context, req rabbit.DeleteNoteRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteNote", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
...
// UpdateNote mocks base method.
func (m *MocknoteEditor) UpdateNote(ctx context.Context, req rabbit.UpdateNoteRequest) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNote", ctx, req)
	ret0, _ := ret[0].(error)
	return ret0
